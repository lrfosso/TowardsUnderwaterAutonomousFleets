import sys
sys.path.append("/home/tor/bluerovSim/bluerov2_garden/install/pubsub_template/lib/python3.10/site-packages/pubsub_template")
## 
...
class Bluerov2PubSubNode(Node):
    ...
    def __init__(self):
        self.ready = False
        super().__init__('bluerov3_pubsub')
    ...
    #Init code
       ...
       # self.z_sp_subscriber
        ...
        self.publisher_1 = self.create_publisher(Float64, '/model/bluerov3/joint/thruster1_joint/cmd_thrust', 10)
        self.publisher_2 = self.create_publisher(Float64, '/model/bluerov3/joint/thruster2_joint/cmd_thrust', 10)
        self.publisher_3 = self.create_publisher(Float64, '/model/bluerov3/joint/thruster3_joint/cmd_thrust', 10)
        self.publisher_4 = self.create_publisher(Float64, '/model/bluerov3/joint/thruster4_joint/cmd_thrust', 10)
        self.publisher_5 = self.create_publisher(Float64, '/model/bluerov3/joint/thruster5_joint/cmd_thrust', 10)
        self.publisher_6 = self.create_publisher(Float64, '/model/bluerov3/joint/thruster6_joint/cmd_thrust', 10)
        self.publisher_7 = self.create_publisher(Float64, '/model/bluerov3/joint/thruster7_joint/cmd_thrust', 10)
        self.publisher_8 = self.create_publisher(Float64, '/model/bluerov3/joint/thruster8_joint/cmd_thrust', 10)        
