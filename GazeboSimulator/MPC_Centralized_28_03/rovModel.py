...
class MyROVModel():
    def __init__(self):
        ...
        #quaternions
        q_0_2 = self.model.set_variable('_x','q_0_2')
        e_1_2 = self.model.set_variable('_x','e_1_2')
        e_2_2 = self.model.set_variable('_x','e_2_2')
        e_3_2 = self.model.set_variable('_x','e_3_2')
        ...
        q_0_sp_2 = self.model.set_variable('_tvp','q_0_sp_2')
        e_1_sp_2 = self.model.set_variable('_tvp','e_1_sp_2')
        e_2_sp_2 = self.model.set_variable('_tvp','e_2_sp_2')
        e_3_sp_2 = self.model.set_variable('_tvp','e_3_sp_2')
...
################### DYNAMICS ROV2 #######################################################################################
       ...
       # self.model.set_rhs('psi_2', (sin(phi_2)/cos(theta_2))*q_2 + (cos(phi_2)/cos(theta_2))*r_2)
        ...
        self.model.set_rhs('x_2',(1 - 2*(e_2_2**2 + e_3_2**2))*u_2 + 2*(e_1_2*e_2_2 - e_3_2*q_0_2)*v_2 + 2*(e_1_2*e_3_2 + e_2_2*q_0_2)*w_2 )
        self.model.set_rhs('y_2', 2*(e_1_2*e_2_2 + e_3_2*q_0_2)*u_2 + (1 - 2*(e_1_2**2 + e_3_2**2))*v_2 + 2*(e_2_2*e_3_2 - e_1_2*q_0_2)*w_2)
        self.model.set_rhs('z_2', 2*(e_1_2*e_3_2 - e_2_2*q_0_2)*u_2 + 2*(e_2_2*e_3_2 + e_1_2*q_0_2)*v_2 + (1 - 2*(e_1_2**2 + e_2_2**2))*w_2)
        
        self.model.set_rhs('q_0_2', 0.5*(-e_1_2*p_2 - e_2_2*q_2 - e_3_2*r_2))
        self.model.set_rhs('e_1_2', 0.5*(q_0_2*p_2 - e_3_2*q_2 + e_2_2*r_2))
        self.model.set_rhs('e_2_2', 0.5*(e_3_2*p_2 + q_0_2*q_2 - e_1_2*r_2))
        self.model.set_rhs('e_3_2', 0.5*(-e_2_2*p_2 + e_1_2*q_2 + q_0_2*r_2))
        ...
        g_1_2 = (B-W)*(2*e_1_2*e_3_2 - 2*e_2_2*q_0_2)
        g_2_2 = (B-W)*(2*e_2_2*e_3_2 - 2*e_1_2*q_0_2)
        g_3_2 = (W-B)*(2*e_1_2**2 + 2*e_2_2**2 -1)
        g_4_2 = z_g*W*(2*e_2_2*e_3_2 + 2*e_1_2*q_0_2)
        g_5_2 = z_g*W*(2*e_1_2*e_3_2 - 2*e_2_2*q_0_2)
        g_6_2 = 0
