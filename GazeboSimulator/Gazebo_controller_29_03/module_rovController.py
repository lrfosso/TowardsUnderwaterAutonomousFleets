...
class MyController():
    def __init__(self, rovModel, Cost_function_id= 1, n_multi_agent = 0, radius_setp = 2, distance_rovs = 3.5, FOV_range_deg = 90, FOV_range_soft_deg = 45, FOV_constraint = False):
