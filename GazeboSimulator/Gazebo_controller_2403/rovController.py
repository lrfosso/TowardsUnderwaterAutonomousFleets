    ...
    def __init__(self, rovModel1, trackMode,  setPoints = [0,0,3,0.5,0.5,0.5,0.5]):
        ...
        match trackMode:
            ...
            case 4:
                ...
                ((((_tvp_rov1['x_2']-_x_rov1['x'])**2+(_tvp_rov1['y_2']-_x_rov1['y'])**2)-length**2)**2) +
                6*(_x_rov1['z']-_tvp_rov1['z_sp'])**2) + 50*((((_x_rov1['q_0']*_tvp_rov1['q_0_sp']+_x_rov1['e_1'] * _tvp_rov1['e_1_sp']+_x_rov1['e_2']* _tvp_rov1['e_2_sp']+_x_rov1['e_3']* _tvp_rov1['e_3_sp'])**2-1)**2 )
        ...
        #    2*(0-((1-(2*_x_rov1['e_2']**2+2*_x_rov1['e_3']**2))*(_tvp_rov1['x_2']-_x_rov1['x'])
